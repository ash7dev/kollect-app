...
/***
 * // app/_layout.tsx - VERSION ULTRA SIMPLIFIÉE
...
function RootLayoutContent() {
  ...
  // Navigation unique vers le modal au démarrage
  useEffect(() => {
    if (!hasNavigated.current) {
      hasNavigated.current = true;
      console.log('🚀 Navigation vers /modal');
      
      // Navigation immédiate vers le modal
      setTimeout(() => {
        router.push('/modal');
      }, 100);
    }
