...
export default function ClientNotificationsScreen() {
  ...
  // Si l'utilisateur n'est pas connecté, on affiche un écran invité
  if (!user) {
    return (
      <SafeAreaView
      ...
      >
        ...
        <View style={styles.centerContainer}>
          ...
          >
            Crée un compte ou connecte-toi pour suivre tes commandes et les mises à jour.
          </Text>

          <TouchableOpacity
            style={styles.loginButton}
            activeOpacity={0.85}
            onPress={() => router.push('/(auth)/login?redirect=/clientNotification')}
          >
            <LinearGradient
            ...
            >
              <Ionicons name="log-in-outline" size={20} color={theme.colors.card} />
